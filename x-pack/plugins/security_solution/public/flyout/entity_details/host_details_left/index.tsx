...
console.log(path)
  const [selectedTabId1, setSelectedTabId1] = useState<EntityDetailsLeftPanelTab>(
  ...
  return (
    <>
      <LeftPanelHeader
        selectedTabId={selectedTabId1}
        setSelectedTabId={setSelectedTabId1}
        tabs={tabs}
      />
      <LeftPanelContent selectedTabId={selectedTabId1} tabs={tabs} />
    </>
  );
};
